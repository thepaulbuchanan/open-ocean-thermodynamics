...
# Create the output figures tree structure
...
# Save image file to directory array
save_path = "paper/figures/thermal_propagation_2d.png"
plt.savefig(save_path, bbox_inches='tight')
plt.close()

print(f"🖼️ Production graphics compiled directly to: {save_path}")
